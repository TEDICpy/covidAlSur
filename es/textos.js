window.textos = {
  ...
  "grafico2.title": "Downloads y acceso a internet",
  "grafico2.description": "Basándonos en la cantidad de descargas de cada app, relativas a la población de cada país, podemos también comparar la llegada que tienen las apps a la población entre países. Aquí se ve una división aún más grande entre apps con alta incidencia y apps con mucha menor penetración.",

  "grafico3.title": "¿Cuánta seguridad ofrecen las apps para los datos que recogen?",
